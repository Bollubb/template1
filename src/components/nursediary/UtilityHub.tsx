...
function ToolInteractions({ onSave, onUpsell }: { onSave: (item: UtilityHistoryItem) => void; onUpsell: (t: string, d: string) => void }) {
  ...
  const DB: Entry[] = [
    ...
    {
      id: "extra_1",
      name: "Farmaco extra 1",
      group: "Extra",
      interactions: [],
    },
    {
      id: "extra_2",
      name: "Farmaco extra 2",
      group: "Extra",
      interactions: [],
    },
    {
      id: "extra_3",
      name: "Farmaco extra 3",
      group: "Extra",
      interactions: [],
    },
